...
public class HUDPointsImpl extends Label implements IHUDPoints {
    ...
    public HUDPointsImpl() {
        ...
        this.backImage = new BackgroundImage(
                new Image(new File(HUDParameters.PNG_FOLDER + "info_label.png").toURI().toString(), PREF_WIDTH,
                        PREF_HEIGHT, HUDParameters.RATIO, HUDParameters.SMOOTH),
                BackgroundRepeat.REPEAT, BackgroundRepeat.REPEAT, BackgroundPosition.DEFAULT, DEFAULT_SIZE);
