...
public class HUDBonusImpl implements IHUDBonus {
    ...
    public void addBonuses() {
        ...
        this.bonus[index] = new ImageView(
                new Image(new File(HUDParameters.PNG_FOLDER + "bonusLife.png").toURI().toString(), SPACING, SPACING,
         ...
         */
        this.bonus[index] = new ImageView(
                new Image(new File(HUDParameters.PNG_FOLDER + "BonusSpeed.png").toURI().toString(), SPACING, SPACING,
                        HUDParameters.RATIO, HUDParameters.SMOOTH));
        this.bonus[index].setLayoutX(X_LAYOUT);
        this.bonus[index].setLayoutY(index * -SPACING);
        this.bonus[index].setTranslateY(X_TRANSLATION);
         ...
         */
        this.bonus[index] = new ImageView(
                new Image(new File(HUDParameters.PNG_FOLDER + "malusCommand.png").toURI().toString(), SPACING, SPACING,
                        HUDParameters.RATIO, HUDParameters.SMOOTH));
        this.bonus[index].setLayoutX(X_LAYOUT);
        this.bonus[index].setLayoutY(index * -SPACING);
        this.bonus[index].setTranslateY(X_TRANSLATION);
         ...
         */
        this.bonus[index] = new ImageView(
                new Image(new File(HUDParameters.PNG_FOLDER + "malusFire.png").toURI().toString(), SPACING, SPACING,
                        HUDParameters.RATIO, HUDParameters.SMOOTH));
        this.bonus[index].setLayoutX(X_LAYOUT);
        this.bonus[index].setLayoutY(index * -SPACING);
        this.bonus[index].setTranslateY(X_TRANSLATION);
         ...
         */
        this.bonus[index] = new ImageView(
                new Image(new File(HUDParameters.PNG_FOLDER + "malusSpeed.png").toURI().toString(), SPACING, SPACING,
                        HUDParameters.RATIO, HUDParameters.SMOOTH));
        this.bonus[index].setLayoutX(X_LAYOUT);
        this.bonus[index].setLayoutY(index * -SPACING);
        this.bonus[index].setTranslateY(X_TRANSLATION);
