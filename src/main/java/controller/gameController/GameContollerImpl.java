...
public class GameContollerImpl implements GameController {
  ...
  public GameContollerImpl(GameField gamefield) {
    ...
    this.inputController =
      new InputControllerImpl(this.player.getNode().getScene(), this.player);
  ...
  public void update() {
    ...
    ) this.player.setDirection(Direction.LEFT); else this.player.setDirection(
        Direction.RIGHT
      );

    if (this.controlStates.get(InputCommand.GO_RIGHT)) if (
      !this.player.isInvertedCommand()
    ) this.player.setDirection(Direction.RIGHT); else this.player.setDirection(
        Direction.LEFT
      );
