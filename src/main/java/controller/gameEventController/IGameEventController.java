...
/**
 * This interface shows the methods that are used in order to handle the HUD situations and
 * coordinating the events with the game conditions. Detecting collisions causes changes in HUD and
 * in the stats of the player.
 */
public interface IGameEventController {
  /**
   * end the game loop and sets a new GUI showing the points earned and giving you the choice
   * beetween saving and quitting or just quitting.
   */
  void endGame();
