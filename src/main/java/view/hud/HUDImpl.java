...
public class HUDImpl implements IHUD {
    ...
    private void createHUD() {
        /*
         * Points HUD, setting position on screen due to his definition: it is a label
         * part so it needs a position on screen and it needs to be added on the nodes
         * system, same for other nodes.
         */
